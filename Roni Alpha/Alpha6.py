    ...
    def plot_current_molecule(self):
        ...
        for i, line in enumerate(lines, 1):
            ...
            if len(data) >= 4:  # Ensure each line has at least four elements
                ...
                atom_names.append(atom_name)  # Store atom name
        ...
        # Get atomic numbers corresponding to atom names
        atom_numbers = [atom_names_to_numbers.get(atom_name, 6) for atom_name in atom_names]
        ...
        plot_molecule(xyz_data, connections, element_data, atom_numbers, file_name)
